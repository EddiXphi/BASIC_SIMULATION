...
def mixed_linear_congruential_generator(a, c, m, seed, n):
    """
    Generates pseudo-random numbers using the mixed linear congruential method.
...
# generated_numbers = mixed_linear_congruential_generator(a, c, m, seed, n)
